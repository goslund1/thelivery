...
**In progress — core built 2026-07-13 (commit 3b4cee4). Escape flash bug fixed 2026-07-13 (commit d1ed193). Remaining: ~~Gallery entry point carId pre-fill~~ done 2026-07-13, figure-pick upload using session car, multi-car detection on [change].**
